  ...
  return (
    <section className="relative h-[90vh] min-h-[560px] max-h-[800px] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.08] pointer-events-none"
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='4' stitchTiles='stitch' result='noise'/%3E%3CfeFlood flood-color='%232A2421' result='color'/%3E%3CfeBlend in='color' in2='noise' mode='multiply'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)'/%3E%3C/svg%3E")`,
